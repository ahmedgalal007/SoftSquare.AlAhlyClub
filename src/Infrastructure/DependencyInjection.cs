...
using SoftSquare.AlAhlyClub.Infrastructure.Constants.ClaimTypes;
using SoftSquare.AlAhlyClub.Infrastructure.Constants.Database;
using SoftSquare.AlAhlyClub.Infrastructure.PermissionSet;
using SoftSquare.AlAhlyClub.Infrastructure.Constants.User;
using SoftSquare.AlAhlyClub.Infrastructure.Persistence.Interceptors;
using SoftSquare.AlAhlyClub.Infrastructure.Services.MultiTenant;
using SoftSquare.AlAhlyClub.Infrastructure.Services.PaddleOCR;
using SoftSquare.AlAhlyClub.Infrastructure.Services.Serialization;
...
namespace SoftSquare.AlAhlyClub.Infrastructure;
        ...
        switch (dbProvider.ToLowerInvariant())
        {
            case DbProviderKeys.Npgsql:
                ...
                return builder.UseNpgsql(connectionString,
                        e => e.MigrationsAssembly("SoftSquare.AlAhlyClub.Migrators.PostgreSQL"))
                    .UseSnakeCaseNamingConvention();

            case DbProviderKeys.SqlServer:
                return builder.UseSqlServer(connectionString,
                    e => e.MigrationsAssembly("SoftSquare.AlAhlyClub.Migrators.MSSQL"));

            case DbProviderKeys.SqLite:
                return builder.UseSqlite(connectionString,
                    e => e.MigrationsAssembly("SoftSquare.AlAhlyClub.Migrators.SqLite"));
