using SoftSquare.AlAhlyClub.Application.Features.Loggers.Queries.PaginationQuery;

namespace SoftSquare.AlAhlyClub.Application.Features.Loggers.Specifications;
...
public class LoggerAdvancedSpecification : Specification<Logger>
{
  public LoggerAdvancedSpecification(LogsWithPaginationQuery filter)
    {
        int timeZoneOffset = filter.TimeZoneOffset;
