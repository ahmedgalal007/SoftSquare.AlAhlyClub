...
using SoftSquare.AlAhlyClub.Application.Features.KeyValues.Specifications;

namespace SoftSquare.AlAhlyClub.Application.Features.KeyValues.Queries.PaginationQuery;
